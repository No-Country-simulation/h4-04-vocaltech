  ...
  return (
    <div className="bg-white p-8 md:p-10 rounded-lg shadow-md w-full max-w-[1500px] border border-gray-300">
      ...
      <div className="grid grid-cols-4 gap-8 w-full pb-4">
        ...
        <div className="col-span-1 flex flex-col items-start gap-9 w-[250px]">
          ...
          {/* Emprendedores */}
          <div className="flex h-[108px] p-2 items-end gap-2 rounded-lg bg-white w-full ">
            <img src={emprendedor} alt="Emprendedores" className="h-[100px] w-[100px] rounded-md object-cover -ml-3" />
            <div className="flex flex-col gap-2 h-[106%]">
              <h3 className="text-[15px] font-semibold text-black gap-1">Emprendedores</h3>
              <p className="text-[13px]  text-black font-manrope  leading-tight">
          ...
          <div className="flex h-[108px] p-2 items-end gap-4 rounded-lg bg-white w-full">
            ...
            <div className="flex flex-col gap-2 h-[110%]">
              <h3 className="text-[15px] font-semibold text-black">Empresas</h3>
              <p className="text-[14px] text-black font-manrope leading-tight">
...
<div className="col-span-1 w-[250px]">
  ...
  <ul className="flex flex-col gap-y-3 text-[#222] text-[15px] font-medium font-manrope text-justify leading-tight">
